...
public class Shader
{
    ...
    private void addAllAttributes(String shaderText)
    {
        ...
        int attributeStartLocation = shaderText.indexOf(ATTRIBUTE_KEYWORD); //look for uniform keyword and get its position
        int attribNumber = 0;
    ...
    private HashMap<String, ArrayList<GLSLStruct>> findUniformStructs(String shaderText)
    {
        ...
        int structStartLocation = shaderText.indexOf(STRUCT_KEYWORD); //look for uniform keyword and get its position
    ...
    private void addAllUniforms(String shaderText)
    {
        ...
        int uniformStartLocation = shaderText.indexOf(UNIFORM_KEYWORD); //look for uniform keyword and get its position
		...
		try
		{
			...
			while((line = shaderReader.readLine()) != null)
			{
                if(line.startsWith(INCLUDE_DIRECTIVE))
                {
                    /*
                    add include system
                    syntax: [#include "file.h"] or [#include <file.h>]
                     */
