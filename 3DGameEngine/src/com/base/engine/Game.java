...
public class Game 
{
	...
	SpotLight sLight1 = new SpotLight(new PointLight(new BaseLight(new Vector3f(1f,1f,1f), 0.8f), new Attenuation(0,0,0.1f), new Vector3f(-2,0,5f), 30),
									  new Vector3f(1,1,1), 0.7f);
	
	public Game()
	{
		material = new Material(new Texture("box.png"), new Vector3f(1,1,1), 1, 8);
